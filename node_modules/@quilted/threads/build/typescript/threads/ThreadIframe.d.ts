 ...
 */
export declare class ThreadIframe<Imports = Record<string, never>, Exports = Record<string, never>> extends Thread<Imports, Exports> {
     ...
     * ```
     */
    static import<Imports = Record<string, never>>(iframe: HTMLIFrameElement, options?: Omit<ThreadWindowOptions<Imports, Record<string, never>>, 'imports'>): import("../Thread.ts").ThreadImports<Record<string, never>>;
    /**
     ...
     * ```
     */
    static export<Exports = Record<string, never>>(iframe: HTMLIFrameElement, exports: Exports, options?: Omit<ThreadWindowOptions<Record<string, never>, Exports>, 'exports'>): void;
    constructor(iframe: HTMLIFrameElement, { targetOrigin, ...options }?: ThreadWindowOptions<Imports, Exports>);
}
//# sourceMappingURL=ThreadIframe.d.ts.map