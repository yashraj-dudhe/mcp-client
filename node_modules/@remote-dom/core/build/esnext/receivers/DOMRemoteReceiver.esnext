...
import { ROOT_ID, UPDATE_PROPERTY_TYPE_PROPERTY, NODE_TYPE_COMMENT, NODE_TYPE_TEXT, NODE_TYPE_ELEMENT, UPDATE_PROPERTY_TYPE_EVENT_LISTENER, UPDATE_PROPERTY_TYPE_ATTRIBUTE } from '../constants.esnext';
...
class DOMRemoteReceiver {
  ...
  constructor({
    ...
    const { attached } = this;
    const destroyTimeouts = /* @__PURE__ */ new Map();
