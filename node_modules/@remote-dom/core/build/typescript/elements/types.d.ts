 ...
 */
export type RemoteElementEventListenersDefinition<EventListeners extends Record<string, any> = {}> = {
 ...
 */
export type RemoteElementMethodsDefinition<Slots extends Record<string, any> = {}> = {
 ...
 * element and its host representation.
 */
export type RemoteElementPropertiesDefinition<Properties extends Record<string, any> = {}> = {
    [Property in keyof Properties]: RemoteElementPropertyDefinition<Properties[Property]>;
};
/**
 ...
 */
export type RemoteElementPropertyTypeOrBuiltIn<Value = unknown> = typeof String | typeof Number | typeof Boolean | typeof Object | typeof Array | typeof Function | RemoteElementPropertyType<Value>;
/**
 ...
 * and its host representation.
 */
export type RemoteElementSlotsDefinition<Slots extends Record<string, any> = {}> = {
