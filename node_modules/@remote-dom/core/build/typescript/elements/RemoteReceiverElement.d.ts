...
type DOMRemoteReceiverOptions = NonNullable<ConstructorParameters<typeof DOMRemoteReceiver>[0]>;
/**
 ...
 * ```
 */
export declare class RemoteReceiverElement extends HTMLElement {
    /**
...
export {};
//# sourceMappingURL=RemoteReceiverElement.d.ts.map