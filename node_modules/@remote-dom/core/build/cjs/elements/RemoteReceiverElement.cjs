...
const DOMRemoteReceiver = require('../receivers/DOMRemoteReceiver.cjs');
 ...
 * ```
 */
class RemoteReceiverElement extends HTMLElement {
  /**
  ...
  constructor() {
    super();
    const receiver = new DOMRemoteReceiver.DOMRemoteReceiver({
      root: this,
      call: (element, method, ...args) => this.call ? this.call(element, method, ...args) : element[method](...args),
...
exports.RemoteReceiverElement = RemoteReceiverElement;
