...
const RemoteElement = require('./RemoteElement.cjs');
 ...
 */
class RemoteFragmentElement extends RemoteElement.RemoteElement {}

exports.RemoteFragmentElement = RemoteFragmentElement;
